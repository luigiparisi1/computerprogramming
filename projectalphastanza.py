...
st.text('''This app allows you to translate and then analyse a text in any language, 
...
# QUANDO GLI DAI IN PASTO UNA LINGUA CHE STANZA NON SUPPORTA, INVECE DI LANCIARE ERRORE DOVREBBE USCIRE UN MESSAGGIO CHE TI DICE CHE LA LINGUA NON è SUPPORTATA (+++RISOLTO+++)
# NON VISUALIZZARE IL MESSAGGIO DI ERRORE QUANDO LASCI UNO DEI DUE CAMPI VUOTO
